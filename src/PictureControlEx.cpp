...
IMPLEMENT_DYNAMIC(CPictureControlEx, CStatic)

CPictureControlEx::CPictureControlEx()
{
...
BEGIN_MESSAGE_MAP(CPictureControlEx, CStatic)
	ON_WM_PAINT()
END_MESSAGE_MAP()

// CPictureControlEx 메시지 처리기입니다.

void CPictureControlEx::OnPaint()
{
